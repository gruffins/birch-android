...
```
implementation 'com.github.gruffins.birch-android:birch:1.0.1
implementation 'com.github.gruffins.birch-android:birch-timber:1.0.1 // (optional Tree to plug into Timber)
```
